...
\begin{tabular*}{\textwidth}{p{0.65\linewidth}p{0.35\linewidth}}
\textbf{\href{https://nvtsrvp.com/}{\huge Navi Tansaraviput}}
& \multicolumn{1}{r}{
{ Mobile: \href{tel:+10000000000}{(+1) 000-000-0000}}}\\
...
{ Github, LinkedIn: \href{https://github.com/nvtsrvp}{nvtsrvp}}} \\
& \multicolumn{1}{r}{
...
\section{Experience}
  ...
  \resumeSubSubheadingMultiteam
   ...
   {is the internal messaging service that also serves as \href{https://cloud.google.com/pubsub}{Cloud Pub/Sub backend}.}
...
% \resumeItem{Designed and led the deployment of services supporting: \href{https://cloud.google.com/pubsub/docs/samples/pubsub-create-topic-with-kinesis-ingestion}{Kinesis Ingestion to Cloud Pub/Sub}, and a separate forwarder service for Cloud Pub/Sub Cross Region Replication to enhance resilience against regional outages.}
...
\resumeItem{Integrated slim ResNet ML models into cancer diagnosis pipeline using Tensorflow, implementing end-to-end testing and performance benchmarking against ResNet implemented with Keras.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{
        % Developed relevance feedback algorithms, and automatic image recognition architecture for a crowd-sourced image retrieval engine for animal biometrics
        Developed image recognition algorithms for SLOOP, a crowd-sourced animal biometrics retrieval system
        }
        % in Matlab and Python under the supervision of Dr. Srinivas Ravela.
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{
        Developed algorithm for non-invasive vital signs monitoring and breathing anomaly detection.
        % Analyzed the data that had been collected from the non-invasive monitoring sensors (FSR/Emfit/Accelerometers) deployed on patients’ wheelchairs using wavelet analysis and developed algorithms for heart rate and respiration rate estimations, and breathing suspension detection.
        }
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Automated presubmit checks for kernel development version control}
