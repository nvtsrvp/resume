...
\newcommand{\resumeItemBoldedFour}[4]{
  \item\small{
    \textbf{#1}{, #2, \textit{#3}: #4 \vspace{-5pt}}
  }
}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://nvtsrvp.com/}{\Large Navi Tansaraviput}} & Email: \href{mailto:navi@alum.mit.edu}{navi@alum.mit.edu}\\
 
Github: \href{https://github.com/nvtsrvp}{nvtsrvp}\quad LinkedIn: \href{https://linkedin.com/in/nvtsrvp}{nvtsrvp}\quad U.S. Permanent Resident (Green Card) & Mobile: \href{tel:+16176788179}{(+1)617-678-8179} \\
...
\small{ 
  \textit{Software engineer with 9 years of experience, including 7 years in distributed systems, real-time data processing, and networking infrastructure, plus 2 years of industry and research work in ML/AI algorithms. Strong focus on reliability, scalability, and performance optimization.}
}
\vspace{-5pt}
...
\resumeItem{Integrated slim ResNet ML models into cancer diagnosis pipeline using Tensorflow, implementing end-to-end testing and performance benchmarking against ResNet implemented with Keras.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Resolved clock synchonization issue on Oracle linux infrastructure in C++.}
      \resumeItemListEnd
...
\section{Awards}
  \resumeSubHeadingListStart
    \resumeSubItem{Analog Devices Undergraduate Research and Innovation Scholar}
      {Sep 2014 - June 2015}
  \resumeSubHeadingListEnd
...
\section{Skills}
  \resumeSubHeadingListStart
  \resumeItemBoldedColon{Languages}{C++20, Python3, Ruby on Rails, Java, Shell Scripting (bash, zsh), SQL, JavaScript, HTML, CSS}
  \resumeSubHeadingListEnd
...
\section{Activities}
  \resumeSubHeadingListStart
    ...
    \resumeItemBoldedFour{Technical Mentor for Google CorpEng High School Tech Apprentice Program}{Mountain View, CA}{Jan 2019}{Mentored students with their DialogFlow and JS projects.}
