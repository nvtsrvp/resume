...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://whoisnavi.com/}{whoisnavi.com} & Mobile: \href{tel:+16176788179}{+1-617-678-8179} \\
\end{tabular*}
...
\section{Skills}
  \resumeSubHeadingListStart
  \resumeItemBolded{Languages}{C++, Python, Ruby on Rails, Java, JavaScript, SQL, HTML/CSS, Linux/Unix command lines}
  \resumeItemBolded{Expertise}{9 years of experience in software development \vspace{-10pt}
  \begin{itemize}
        \item{\small{Distributed systems, real-time data processing, and networking infrastructure. Strong focus on reliability, scalability, and performance optimization. \vspace{-2pt}}}
        \item{\small{2 years of industry and research experience in ML/AI algorithms \vspace{-2pt}}}
      \end{itemize}
    }
  \resumeSubHeadingListEnd
...
\section{Activities}
  \resumeSubHeadingListStart
    \resumeItemBolded{Google Technical Interviewer}{Jul 2019 -- present}
    \resumeItemBolded{Microsoft TEALS Program Instructor}{Millennium High School, New York, NY, Sep 2024 -- present: Teaching Introduction to Computer Science to a class of 23 high school students.}
    \resumeItemBolded{Technical Mentor for Google CorpEng High School Tech Apprentice Program}{Mountain View, CA, Jan 2019: Mentoring students with their projects in DialogFlow and JavaScript.}
    \resumeItemBolded{FIRST Tech Challenge Robotics Team Mentor}{Waldorf School of the Peninsula, Mountain View, CA, Oct 2017 -- Feb 2018: Mentored high school students in Waldorf School Robotic club to build a robot controller to compete in FIRST Tech Challenge robot competition in Java.}
  \resumeSubHeadingListEnd
