...
{\raisebox{0.0\height}{\footnotesize \faPhone\ \href{tel:+10000000000}{(+1) 000-000-0000}}}
}\\
...
\resumeItem{Integrated slim ResNet ML models into cancer diagnosis pipeline using Tensorflow, implementing end-to-end testing and performance benchmarking against ResNet implemented with Keras.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed web app for log analysis and visualization using HTML/CSS/JS frontend and Python/PostgreSQL backend.}
      \resumeItemListEnd
