...
\newcommand{\resumeItemBoldedFour}[4]{
  \item\small{
    \textbf{#1}{, #2, \textit{#3}: #4 \vspace{-8pt}}
  }
}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://whoisnavi.com/}{\Large Navi Tansaraviput}} & Email: \href{mailto:navi@alum.mit.edu}{navi@alum.mit.edu}\\
  Github: \href{https://github.com/nvtnsrvp}{nvtnsrvp}\quad\quad LinkedIn: \href{https://linkedin.com/in/navitan}{navitan}\quad\quad U.S. Permanent Resident (Green Card) & Mobile: \href{tel:+16176788179}{(+1)617-678-8179} \\
...
\section{Skills}
  \resumeSubHeadingListStart
  \resumeItemBoldedColon{Languages}{C++, Python, Ruby on Rails, Java, JavaScript, SQL, HTML/CSS, Linux/Unix command lines}
  \resumeItemBoldedColon{Expertise}{9 years of experience in software development \vspace{-10pt}
  \begin{itemize}
        \item{\small{Distributed systems, real-time data processing, and networking infrastructure. Strong focus on reliability, scalability, and performance optimization. \vspace{-5pt}}}
        \item{\small{2 years of industry and research experience in ML/AI algorithms \vspace{-5pt}}}
      \end{itemize}
    }
  \resumeSubHeadingListEnd
